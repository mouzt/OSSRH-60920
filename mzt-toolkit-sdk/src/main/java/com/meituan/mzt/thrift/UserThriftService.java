...
public class UserThriftService {
    ...
    public interface Iface {
        ...
        public boolean updateUserInfo(String misId, String name) throws org.apache.thrift.TException;
    }

    public interface AsyncIface {

        public void updateUserInfo(String misId, String name, org.apache.thrift.async.AsyncMethodCallback<AsyncClient.updateUserInfo_call> resultHandler) throws org.apache.thrift.TException;
    }
    ...
    public static class Client extends org.apache.thrift.TServiceClient implements Iface {
        ...
        public boolean updateUserInfo(String misId, String name) throws org.apache.thrift.TException {
            send_updateUserInfo(misId, name);
            return recv_updateUserInfo();
        }

        public void send_updateUserInfo(String misId, String name) throws org.apache.thrift.TException {
        ...
        public boolean recv_updateUserInfo() throws org.apache.thrift.TException {
    ...
    public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
        ...
        public void updateUserInfo(String misId, String name, org.apache.thrift.async.AsyncMethodCallback<updateUserInfo_call> resultHandler) throws org.apache.thrift.TException {
            checkReady();
            updateUserInfo_call method_call = new updateUserInfo_call(misId, name, resultHandler, this, ___protocolFactory, ___transport);
        ...
        public static class updateUserInfo_call extends org.apache.thrift.async.TAsyncMethodCall {
            ...
            public updateUserInfo_call(String misId, String name, org.apache.thrift.async.AsyncMethodCallback<updateUserInfo_call> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
    ...
    public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
        ...
        private static class updateUserInfo<I extends Iface> extends org.apache.thrift.ProcessFunction<I, updateUserInfo_args> {
            ...
            protected updateUserInfo_result getResult(I iface, updateUserInfo_args args) throws org.apache.thrift.TException {
                updateUserInfo_result result = new updateUserInfo_result();
                result.success = iface.updateUserInfo(args.misId, args.name);
    ...
    public static class updateUserInfo_args implements org.apache.thrift.TBase<updateUserInfo_args, updateUserInfo_args._Fields>, java.io.Serializable, Cloneable {
        ...
        private static final org.apache.thrift.protocol.TField MIS_ID_FIELD_DESC = new org.apache.thrift.protocol.TField("misId", org.apache.thrift.protocol.TType.STRING, (short) -1);
        ...
        public enum _Fields implements org.apache.thrift.TFieldIdEnum {
            ...
            MIS_ID((short) -1, "misId"), NAME((short) -2, "name");
        ...
        static {
            ...
            tmpMap.put(_Fields.MIS_ID, new org.apache.thrift.meta_data.FieldMetaData("misId", org.apache.thrift.TFieldRequirementType.DEFAULT, new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
        ...
        public updateUserInfo_args(String misId, String name) {
            this();
            this.misId = misId;
            this.name = name;
        }
        ...
        public updateUserInfo_args setMisId(String misId) {
            this.misId = misId;
            return this;
        }

        public void unsetMisId() {
            this.misId = null;
        }

        /**
         * Returns true if field misId is set (has been assigned a value) and false otherwise
         */
        public boolean isSetMisId() {
            return this.misId != null;
        }

        public void setMisIdIsSet(boolean value) {
            if (!value) {
                this.misId = null;
            }
        }
        ...
        public updateUserInfo_args setName(String name) {
            this.name = name;
            return this;
        }
        ...
        public boolean equals(updateUserInfo_args that) {
            if (that == null)
                return false;
            boolean this_present_misId = true && this.isSetMisId();
            boolean that_present_misId = true && that.isSetMisId();
            if (this_present_misId || that_present_misId) {
                if (!(this_present_misId && that_present_misId))
                    return false;
                if (!this.misId.equals(that.misId))
                    return false;
            }
        ...
        public int compareTo(updateUserInfo_args other) {
            ...
            lastComparison = Boolean.valueOf(isSetMisId()).compareTo(typedOther.isSetMisId());
            if (lastComparison != 0) {
                return lastComparison;
            }
            if (isSetMisId()) {
                lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.misId, typedOther.misId);
                if (lastComparison != 0) {
                    return lastComparison;
                }
            }
        ...
        private static class updateUserInfo_argsStandardScheme extends StandardScheme<updateUserInfo_args> {
                    ...
                    switch(schemeField.id) {
                        ...
                        -1:
                            if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
                                struct.misId = iprot.readString();
                                struct.setMisIdIsSet(true);
                            } else {
            ...
            public void write(org.apache.thrift.protocol.TProtocol oprot, updateUserInfo_args struct) throws org.apache.thrift.TException {
                ...
                if (struct.misId != null) {
                    oprot.writeFieldBegin(MIS_ID_FIELD_DESC);
                    oprot.writeString(struct.misId);
                    oprot.writeFieldEnd();
                }
    ...
    public static class updateUserInfo_result implements org.apache.thrift.TBase<updateUserInfo_result, updateUserInfo_result._Fields>, java.io.Serializable, Cloneable {
        ...
        public updateUserInfo_result(boolean success) {
            this();
        ...
        public updateUserInfo_result setSuccess(boolean success) {
            this.success = success;
            setSuccessIsSet(true);
            return this;
        }
